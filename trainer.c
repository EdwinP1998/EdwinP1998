...
int main()
{
	...
	while (showMenu)
	{
		...
		case 2: 
			...
			break;
		case 3:
			result = ModifyRangedAttack(hTarget, playerStatsPointer);
			break;
		case 4:
			result = ModifyRangedDamage(hTarget, playerStatsPointer);
			break;
		case 5:
			result = ModifyMeleeDamage(hTarget, playerStatsPointer);
			break;
		default:
